      ...
      <div class="mainCon">
        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              <div class="controls">
                <input @change="sumNumchange" v-model="sumNum" autocomplete="off" class="itxt" />
                <a @click="sumNum++" href="javascript:" class="plus">+</a>
                <a @click="sumNum>1?sumNum--:sumNum=1" href="javascript:" class="mins">-</a>
              </div>
              <div class="add">
...
export default {
  ...
  mounted() {
    this.$store.dispatch("detailInfo", this.$route.params.id);
  },
  computed: {
    ...mapState({
      detailInfo: (state) => {
  ...
  methods:{
    ...
    sumNumchange(event){
      ...
      if(isNaN(value)||value<1){
        ...
        this.sumNum = parseInt(event.target.value)
      }
    },
    async addToCart(){
      // let result = this.$store.dispatch('addtoCart',{skuId:this.$route.params.id,skuNum:this.sumNum})
      // console.log(result)
      try {
        await this.$store.dispatch('addtoCart',{skuId:this.$route.params.id,skuNum:this.sumNum})
        this.$router.push({name:'addcartsuccess',params:{skuNum:this.sumNum}})
