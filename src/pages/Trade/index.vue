  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      >
        ...
        <p>
          ...
          <span class="s3" v-if="index == selectedIndex">默认地址</span>
        </p>
      </div>
      ...
      <div class="way">
        <h5>配送方式</h5>
        <div class="info clearFix address">
          <span class="username selected">天天快递</span>
          <!-- <span class="username selected">天天快递</span> -->
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul v-for="good in goodsList" :key="good.skuId" class="list clearFix">
          <li>
            <img :src="good.imgUrl" />
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{ currAddress.fullAddress }}</span>
        收货人：<span>{{ currAddress.consignee }}</span>
        <span>{{ currAddress.phoneNum }}</span>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    async submitOrder() {
      let data = {
        consignee: this.currAddress.consignee,
        consigneeTel: this.currAddress.phoneNum,
        deliveryAddress: this.currAddress.fullAddress,
        paymentWay: "ONLINE",
  ...
  watch: {
    address(newValue) {
      this.selectedIndex = newValue.findIndex((element) => {
